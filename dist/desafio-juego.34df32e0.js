...
var _index = require("./components/hand-el/index");
var _index1 = require("./components/text-el/index");
var _index2 = require("./components/button-el/index");
var _index3 = require("./components/counter-el/index");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"38ban":[function(require,module,exports,__globalThis) {
...
class Counter extends HTMLElement {
    ...
    `;
        ...
        this.intervalId = window.setInterval(()=>{
            this.counter--;
            if (circle) {
                if (this.counter >= 0) circle.innerHTML = `<my-text variant="counter"> ${String(this.counter)}</my-text>
`;
                else {
                    ...
                    this.dispatchEvent(new CustomEvent("timeout", {
                        bubbles: true,
                        detail: {
                            text: "tiempo de ronda finalizado"
                        }
                    }));
                }
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7ICAO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dKDif":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
