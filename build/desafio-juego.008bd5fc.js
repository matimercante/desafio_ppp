...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</my-text>
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#reset-btn");e?.addEventListener("click",e=>{e.preventDefault(),t.goTo("/start")})}),o}}];m.init();const v=document.querySelector(".root");v&&function(t){function e(t){history.pushState({},"",t),n(t)}function n(n){for(let o of u)if(o.path.test(n)){let n=o.handler({goTo:e});t.firstChild&&t.firstChild.remove(),t.appendChild(n)}}let o=location.pathname;"/"==o?n("/home"):n(o)}(v);
//# sourceMappingURL=desafio-juego.008bd5fc.js.map
