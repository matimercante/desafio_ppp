var t=globalThis,e={},n={},a=t.parcelRequire230e;null==a&&((a=function(t){if(t in e)return e[t].exports;if(t in n){var a=n[t];delete n[t];var o={id:t,exports:{}};return e[t]=o,a.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){n[t]=e},t.parcelRequire230e=a);var o=a.register;o("ko4eS",function(t,e){t.exports=import.meta.resolve("fhohL")}),o("foGl6",function(t,e){t.exports=import.meta.resolve("hLjVK")}),o("lgw0O",function(t,e){t.exports=import.meta.resolve("jZ9sI")});const i={tijeras:a("ko4eS"),piedra:a("foGl6"),papel:a("lgw0O")};class r extends HTMLElement{shadow=this.attachShadow({mode:"open"});variant="";estilo="";constructor(){super();let t=this.getAttribute("variant");this.variant=t;let e=this.getAttribute("estilo");this.estilo=e??""}connectedCallback(){this.render();let t=this.shadow.querySelector(`#${this.variant}`);"computer"!==this.estilo&&t?.addEventListener("click",this.onClick),document.addEventListener("computermove",this.onComputerMove)}disconnectedCallback(){let t=this.shadow.querySelector(`#${this.variant}`);t?.removeEventListener("click",this.onClick),this.removeEventListener("computermove",this.onComputerMove)}onClick=t=>{t.preventDefault(),this.dispatchEvent(new CustomEvent("handselected",{detail:{id:this.variant,info:"item clicked"},bubbles:!0,composed:!0}))};onComputerMove=t=>{let e=this.shadow.querySelector(`#${this.variant}`),n=t.detail;"computer"===this.estilo&&this.variant===n.id&&(console.log(this.variant,n.id),e?.classList.add("show"))};render(){this.shadow.innerHTML=`
      <style>
        .container {
          max-width:375px;;
        }
...
`:(t.classList.add("hide"),clearInterval(this.intervalId),this.dispatchEvent(new CustomEvent("timeout",{bubbles:!0,detail:{text:"tiempo de ronda finalizado"}}))))},1e3)}}customElements.define("my-counter",c);class d extends HTMLElement{shadow=this.attachShadow({mode:"open"});textResult;constructor(){super(),this.textResult=this.getAttribute("variant"),this.connectecCallback()}connectecCallback(){this.render()}render(){this.shadow.innerHTML=`
    ...
    `,this.shadow.append(t)}}customElements.define("my-score",h);const p={data:{userPlay:"",computerPlay:""},history:[],listeners:[],init(){this.syncWithLocalStorage()},getState(){return this.data},getHistory(){return this.history},setState(t){for(let e of(this.data=t,this.history.push({...t}),this.listeners));localStorage.setItem("state",JSON.stringify(t)),localStorage.setItem("history",JSON.stringify(this.history))},subscribe(t){this.listeners.push(t)},setPlay(t,e){let n=this.getState();n.userPlay=t,n.computerPlay=e,this.setState(n)},getScore(){let t=this.history,e=0,n=0;return t.forEach(t=>{let a=t.userPlay,o=t.computerPlay;a==o?(e++,n++):"papel"==a&&"tijeras"==o||"tijeras"==a&&"piedra"==o||"piedra"==a&&"papel"==o?n++:("papel"==o&&"tijeras"==a||"tijeras"==o&&"piedra"==a||"piedra"==o&&"papel"==a)&&e++}),e>n?console.log("ganaste"):e==n?console.log("empate"):console.log("ganó la computadora"),{userPoints:e,computerPoints:n}},resetGame(){this.data.userPlay="",this.data.computerPlay="",this.history=[],localStorage.removeItem("state"),localStorage.removeItem("history")},syncWithLocalStorage(){let t=localStorage.getItem("state"),e=localStorage.getItem("history");t&&(this.data=JSON.parse(t)),e&&(this.history=JSON.parse(e))}},m=["piedra","papel","tijeras"],u="/piedra_papel_tijeras",v=[{path:/\/piedra_papel_tijeras\/home/,handler:function(t){let e=document.createElement("div");return e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#start-btn");e?.addEventListener("click",e=>{e.preventDefault(),t.goTo("/start")})}),e}},{path:/\/piedra_papel_tijeras\/start/,handler:function(t){let e=document.createElement("div");return e.innerHTML=`
...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</my-text>
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#play-btn");e?.addEventListener("click",e=>{e.preventDefault(),p.resetGame(),t.goTo("/game")})}),e}},{path:/\/piedra_papel_tijeras\/game/,handler:function(t){var e=!1;let n=m[Math.floor(Math.random()*m.length)],a=document.createElement("div");return a.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{a.addEventListener("timeout",()=>{if(console.log("Tiempo terminado"),!1==e){let e=m[Math.floor(Math.random()*m.length)];p.setPlay(e,n),p.getHistory().length<3?t.goTo("/game"):t.goTo("/results")}}),a.addEventListener("handselected",o=>{let i=o.detail;e=!0,a.dispatchEvent(new CustomEvent("computermove",{detail:{id:n,description:"computer move"},bubbles:!0,composed:!0})),p.setPlay(i.id,n),p.getHistory().length<3?setTimeout(()=>{t.goTo("/game")},1e3):setTimeout(()=>{t.goTo("/results")},1e3)})}),a}},{path:/\/piedra_papel_tijeras\/results/,handler:function(t){var e="";let n=p.getScore();e=n.userPoints>n.computerPoints?"Ganaste":n.userPoints==n.computerPoints?"Empate":"Perdiste";let a=document.createElement("div");return a.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#reset-btn");e?.addEventListener("click",e=>{e.preventDefault(),t.goTo("/start")})}),a}}];function g(){return location.host.includes("matimercante.github.io")}p.init();const y=document.querySelector(".root");y&&function(t){function e(t){let e=g()?u+t:t;history.pushState({},"",e),n(e)}function n(n){let a=g()?u+n:n;for(let n of v)if(n.path.test(a)){let a=n.handler({goTo:e});t.firstChild&&t.firstChild.remove(),t.appendChild(a)}}let a=location.pathname;"/"==a?n("/home"):n(a)}(y);
//# sourceMappingURL=desafio-juego.2ce13823.js.map
