...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</my-text>
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#reset-btn");e?.addEventListener("click",e=>{e.preventDefault(),t.goTo("/start")})}),o}}];function g(){return location.host.includes("github.io")}m.init();const y=document.querySelector(".root");y&&function(t){function e(t){let e=g()?u+t:t;history.pushState({},"",e),n(e)}function n(n){let o=g()?u+n:n;for(let n of v)if(n.path.test(o)){let o=n.handler({goTo:e});t.firstChild&&t.firstChild.remove(),t.appendChild(o)}}let o=location.pathname;"/"==o?n("/home"):n(o),window.onpopstate=function(){n(location.pathname)}}(y);
//# sourceMappingURL=desafio-juego.1285221e.js.map
