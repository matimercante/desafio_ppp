...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</my-text>
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#play-btn");e?.addEventListener("click",e=>{e.preventDefault(),p.resetGame(),t.goTo("/game")})}),e}},{path:/\/piedra_papel_tijeras\/game/,handler:function(t){var e=!1;let n=m[Math.floor(Math.random()*m.length)],o=document.createElement("div");return o.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{o.addEventListener("timeout",()=>{if(console.log("Tiempo terminado"),!1==e){let e=m[Math.floor(Math.random()*m.length)];p.setPlay(e,n),p.getHistory().length<3?t.goTo("/game"):t.goTo("/results")}}),o.addEventListener("handselected",a=>{let i=a.detail;e=!0,o.dispatchEvent(new CustomEvent("computermove",{detail:{id:n,description:"computer move"},bubbles:!0,composed:!0})),p.setPlay(i.id,n),p.getHistory().length<3?setTimeout(()=>{t.goTo("/game")},1e3):setTimeout(()=>{t.goTo("/results")},1e3)})}),o}},{path:/\/piedra_papel_tijeras\/results/,handler:function(t){var e="";let n=p.getScore();e=n.userPoints>n.computerPoints?"Ganaste":n.userPoints==n.computerPoints?"Empate":"Perdiste";let o=document.createElement("div");return o.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{let e=document.querySelector("#reset-btn");e?.addEventListener("click",e=>{e.preventDefault(),t.goTo("/start")})}),o}}];function g(){return location.host.includes("matimercante.github.io")}p.init();const y=document.querySelector(".root");y&&function(t){function e(t){let e=g()?u+t:t;history.pushState({},"",e),n(e)}function n(n){let o=g()?u+n:n;for(let n of v)if(n.path.test(o)){let o=n.handler({goTo:e});t.firstChild&&t.firstChild.remove(),t.appendChild(o)}}let o=location.pathname;"/"==o?n("/home"):n(o),window.onpopstate=function(){n(location.pathname)}}(y);
//# sourceMappingURL=desafio-juego.7bac096e.js.map
